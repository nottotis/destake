...
contract ERC20Test is DSTestPlus {
    ...
    function testTransferExample() public {
        token.mint(address(this), 1e18);
        ...
        assertTrue(token.transfer(address(0x1337), 3e17));
        assertEq(token.balanceOf(address(0x1337)), 3e17);
        assertEq(token.balanceOf(address(0xBEEF)), 7e17);
        // emit log_named_uint("Beef baalnce",token.balanceOf(address(0xBEEF)));
        // emit log_named_uint("Leet baalnce",token.balanceOf(address(0x1337)));
        assertEq(token.totalSupply(), 1e18);
        ...
        // token.mint(address(this), 1e18);
        assertEq(token.balanceOf(address(0x1337)), 3e17*2);
        assertEq(token.balanceOf(address(0xBEEF)), 7e17*2);
        ...
        // token.mint(address(this), 1e18);
        // assertEq(token.balanceOf(address(0x1337)), 3e17*0.5);
        // assertEq(token.balanceOf(address(0xBEEF)), 7e17*0.5);
    }
